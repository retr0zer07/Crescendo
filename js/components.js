...
const I18N_STRINGS = {
    en: {
        ...
        heroCompaniesTrust: 'Roadmap aligned to revenue goals',
        heroLeadsGenerated: 'Weekly execution and optimization',
        heroAverageRating: 'One team, fast communication',
    ...
    es: {
        ...
        heroCompaniesTrust: 'Plan alineado a metas de ingresos',
        heroLeadsGenerated: 'Ejecucion y optimizacion semanal',
        heroAverageRating: 'Un equipo, comunicacion rapida',
    ...
    'nosotros.html': {
        en: {
            ...
            text: {
                ...
                '.servicio-detalle .container > h2:nth-of-type(4)': 'Our Numbers',
        ...
        es: {
            ...
            text: {
                ...
                '.servicio-detalle .container > h2:nth-of-type(4)': 'Nuestros Numeros',
...
const PAGE_ES_OVERRIDES = {
    ...
    'nosotros.html': {
        text: {
            '.hero-content h1': 'Crescendo Digital Marketing Agency - Agencia integral de marketing en Miami',
            '.hero-content h2': 'Impulsamos tu negocio con SEO Local, PPC y Meta Ads, Diseno Web, Social Media y Reputacion Online.',
            '.servicio-detalle .container > h2:nth-of-type(1)': 'Nuestra mision',
            '.servicio-detalle .container > p:nth-of-type(1)': 'Ayudar a negocios latinos a dominar el marketing digital. No creemos en soluciones genericas. Cada negocio es unico y cada estrategia tambien.',
            '.servicio-detalle .container > h2:nth-of-type(2)': 'Nuestros valores',
            ...
            '.servicios-grid .servicio-card:nth-child(2) h3': 'Metodologia probada',
            ...
            '.servicios-grid .servicio-card:nth-child(6) h3': 'Capacitacion continua',
            '.servicio-detalle .container > h2:nth-of-type(4)': 'Nuestros numeros',
            '.cta-final h2': 'Conoce mas sobre nuestro trabajo',
            '.cta-final p': 'Revisa algunos de nuestros casos de exito',
            '.cta-final .btn-primary': 'Ver casos de exito',
